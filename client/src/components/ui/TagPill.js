 ...
 * - ariaLabel override
 */
export default function TagPill({ label, active, onClick, onRemove, count, size='sm', ariaLabel }) {
  const base = 'inline-flex items-center gap-1 rounded-full border transition focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 text-xs';
