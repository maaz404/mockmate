...
const SessionSummary = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div
        className={`bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto hover-scrollbar mx-4 ${className}`}
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-surface-200">
          <div>
            ...
            <p className="text-surface-600 mt-1">
              Analysis of your facial expressions and delivery
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="text-center">
              ...
              <div className="grid grid-cols-3 gap-4 mt-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-surface-600">Detection Rate</div>
                </div>
                <div className="text-center">
                  <div className="text-lg font-semibold text-surface-900">
                    {Math.round(100 - metrics.offScreenPercentage)}%
                  </div>
                  <div className="text-sm text-surface-600">On-Screen Time</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div className="bg-purple-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-purple-900">
                  {Math.round(metrics.headSteadiness)}%
                </div>
              ...
              <div className="bg-green-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-green-900">
                  {Math.round(metrics.blinkRate)}/min
                </div>
              ...
              <div className="bg-yellow-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-yellow-900">
                  {Math.round(metrics.smilePercentage)}%
                </div>
              ...
              <div className="bg-indigo-50 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-indigo-900">
                  {Math.round(metrics.environmentQuality)}%
                </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {recommendations.slice(0, 3).map((rec, index) => (
                <div
                  key={index}
                  className="flex items-start space-x-3 p-4 bg-surface-50 rounded-lg"
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-surface-700">{rec.message}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="flex space-x-3 pt-4 border-t border-surface-200">
            <button
              onClick={onClose}
              className="flex-1 px-6 py-3 bg-surface-100 hover:bg-surface-200 text-surface-700 rounded-lg font-medium transition-colors"
            >
              Close
            </button>
            <button
