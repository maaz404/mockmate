  ...
  const testimonials = [
    {
      ...
      avatar: "SC",
      content:
        "MockMate's AI feedback helped me identify and fix my interview weaknesses. I landed my dream job at a top tech company after just 2 weeks of practice!",
      rating: 5,
    ...
    },
    {
      ...
      avatar: "DR",
      content:
        "The personalized learning path was a game-changer. MockMate adapted to my experience level and focused on areas where I needed the most improvement.",
      rating: 5,
    ...
    },
    {
      ...
      avatar: "ET",
      content:
        "Real-time feedback during practice sessions made all the difference. I went from nervous and unprepared to confident and articulate in my interviews.",
      rating: 5,
    ...
    },
    {
      ...
      avatar: "MP",
      content:
        "The industry-specific questions helped me prepare for exactly what companies were looking for. I received multiple offers after using MockMate.",
      rating: 5,
    ...
    },
    {
      ...
      avatar: "JW",
      content:
        "MockMate's analytics showed me exactly where I was losing points in interviews. The detailed feedback helped me improve systematically.",
      rating: 5,
    ...
    },
    {
      ...
      avatar: "AJ",
      content:
        "The mock video interviews felt so realistic that when I had my actual interview, it felt like just another practice session. Highly recommend!",
      rating: 5,
      ...
      <div className="max-w-7xl mx-auto container-padding">
        ...
        >
          ...
          <p className="text-xl text-surface-600 max-w-3xl mx-auto">
            ...
            with MockMate's AI-powered interview preparation.
          </p>
        </motion.div>
