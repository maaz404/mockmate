...
const VideoRecorder = ({ 
  ...
  if (cameraError) {
    return (
      <div className={`bg-red-900/50 border border-red-700 rounded-lg p-6 text-center ${className}`}>
      ...
      <div className="flex justify-center space-x-4">
        ...
        {isRecording && (
          <button
            ...
            className="bg-gray-600 hover:bg-gray-700 p-4 rounded-full transition-colors"
        ...
        {hasRecorded && (
          <>
            ...
            <button
              ...
              disabled={isUploading}
              className="bg-gray-600 hover:bg-gray-700 disabled:bg-gray-800 px-4 py-3 rounded-lg transition-colors"
