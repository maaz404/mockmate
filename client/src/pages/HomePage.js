          ...
          <div className="w-full max-w-4xl mx-auto">
            ...
            <section className="bg-white rounded-3xl shadow-lg border border-slate-200 px-8 py-12 mb-10 flex flex-col items-center text-center">
              ...
              <p className="text-lg md:text-xl text-slate-600 mb-6 max-w-2xl">
                The academic, AI-powered platform for mastering interviews.
                Practice, get feedback, and track your progress—all in one
                place.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="/login" className="btn-secondary px-8 py-3 text-lg">
                  Sign In
                </a>
              </div>
            </section>
            ...
            <section className="mb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-slate-100 rounded-xl p-6 flex flex-col items-start shadow-sm border border-slate-200">
                  <span className="font-semibold text-slate-800 mb-2">
                    AI-powered Interview Questions
                  </span>
                  <span className="text-slate-500 text-sm">
                    Practice with intelligent, adaptive questions tailored to
                    your skills.
                  </span>
                </div>
                <div className="bg-slate-100 rounded-xl p-6 flex flex-col items-start shadow-sm border border-slate-200">
                  ...
                  <span className="text-slate-500 text-sm">
                    Get instant, actionable feedback on your answers and
                    performance.
                  </span>
                </div>
                <div className="bg-slate-100 rounded-xl p-6 flex flex-col items-start shadow-sm border border-slate-200">
                ...
                <div className="bg-slate-100 rounded-xl p-6 flex flex-col items-start shadow-sm border border-slate-200">
                  ...
                  <span className="text-slate-500 text-sm">
                    Choose from technical, behavioral, and system design
                    interviews.
                  </span>
                </div>
              </div>
            ...
            <section className="mb-10">
              ...
              <ul className="space-y-4 max-w-2xl mx-auto text-left">
                <li className="text-slate-700">
                  <strong>How does MockMate work?</strong>
                  <br />
                  MockMate uses AI to generate interview questions and provide
                  feedback based on your answers.
                </li>
                <li className="text-slate-700">
                  <strong>Is it free to use?</strong>
                  <br />
                  Yes, you can get started for free and access core features.
                </li>
                <li className="text-slate-700">
                  <strong>What types of interviews can I practice?</strong>
                  <br />
                  Technical, behavioral, system design, and more.
                </li>
              </ul>
            </section>
            ...
            <section className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-2xl p-8 flex flex-col items-center justify-center shadow-md border border-slate-200">
              ...
              <p className="text-slate-700 mb-4">
                Sign up now and start practicing with AI-powered questions and
                feedback.
              </p>
              <a href="/register" className="btn-primary px-8 py-3 text-lg">
                Get Started Free
