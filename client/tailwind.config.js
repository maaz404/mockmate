    ...
    extend: {
      colors: {
        ...
        secondary: {
          ...
          500: "#a855f7",
          600: "#9333ea",
          700: "#7c3aed", // Main secondary color
          800: "#6b21a8",
          900: "#581c87",
        },
        ...
        surface: {
          ...
          100: "#f3f4f6", // Light navbar/sidebar
          200: "#e5e7eb", // Light borders
          300: "#d1d5db", // Light input borders
          400: "#9ca3af", // Light secondary text
          500: "#6b7280", // Light muted text
          600: "#4b5563", // Light primary text
          700: "#374151", // Dark borders
          800: "#1f2937", // Dark cards/containers
        ...
        // Keep accent for additional variety
        accent: {
          50: "#fdf4ff",
          100: "#fae8ff",
          200: "#f5d0fe",
      ...
      boxShadow: {
        ...
        "glow-blue": "0 0 20px rgba(37, 99, 235, 0.15)", // Primary blue glow
        "glow-secondary": "0 0 20px rgba(124, 58, 237, 0.15)", // Secondary purple glow
        surface:
