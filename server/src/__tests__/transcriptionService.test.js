...
describe('TranscriptionService', () => {
  ...
  describe('transcribeVideo', () => {
    it('should return error when OpenAI is not configured', async () => {
      ...
      const result = await transcriptionService.transcribeVideo('/fake/path', 'test.webm');
    ...
    it('should return error when file does not exist', async () => {
      ...
      const result = await transcriptionService.transcribeVideo('/fake/nonexistent/path', 'test.webm');
  ...
  describe('processVideoTranscription', () => {
    it('should handle error when video processing fails', async () => {
      ...
      expect(result.success).toBe(false);
      expect(mockInterview.save).toHaveBeenCalledTimes(2); // Once for pending, once for failed
